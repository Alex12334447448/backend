...
$stmt_request = $pdo->prepare("SELECT Заявки.*, Автомобили.*
                              FROM Заявки
...
<head>
    ...
    <title>Подтверждение записи - ZhukAvto</title>
    <link rel="stylesheet" href="./assets/css/style.css">
</head>
<body>
    <div class="container">
        <h2 class="h2 section-title">Подтверждение записи</h2>
        <p class="status-message">Вы успешно записаны на просмотр!</p>
